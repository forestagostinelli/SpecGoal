...
python run_search.py --states data/cube3/test/canon.pkl --heur models/cube3/current.pt --env cube3 --batch_size 10000 --weight 1.0 --results_dir results/cube3_cannon/ --redo --time_limit 200
python run_search.py --states data/cube3/test/rand.pkl --heur models/cube3/current.pt --env cube3 --batch_size 10000 --weight 1.0 --results_dir results/cube3_rand/ --redo --time_limit 200
